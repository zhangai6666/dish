...
//            System.out.println(jsonString);
    ...
    public static void main(String[] args) throws IOException{
    	...
    	for(int offset = 0; offset < 211; offset += 30) {
        	JsonParser parser = new JsonParser();
        	StringBuilder jsonString = new StringBuilder();
        	String file = String.format("RawJsonRestaurants_offset_%d.txt", offset);        	
//        	String link = String.format("https://api.foursquare.com/v2/venues/explore?near=Austin,TX&section=Food&offset=%d&oauth_token=3HN5ZNTIV4EBCK5SVFJVFCHIJCBVVI4Q5CFJPYIPXLRUW0Y0&v=20161203", offset);
//            parser.readFromUrl(link, file, jsonString);
        	parser.readFromFile(file, jsonString);
            
//            parser.readFromFile(file, jsonString);
//            System.out.println(jsonString.substring(0, 1040));
            file = String.format("RestaurantList_new_offset_%d.txt", offset);
            ...
            for (Restaurant r : list) {
            	...
            	String menuLink = String.format("https://api.foursquare.com/v2/venues/%s/menu?oauth_token=3HN5ZNTIV4EBCK5SVFJVFCHIJCBVVI4Q5CFJPYIPXLRUW0Y0&v=20161203", r.id);
            	String menuFile = "Menu " + r.id;
...
//            	parser.readFromUrl(menuLink, menuFile, jsonMenu);
            	...
            	r.menus = parser.parseMenu(jsonMenu.toString());
